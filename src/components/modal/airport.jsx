  ...
  return (
    <div className='airport'>
      <div>
        ...
        <span>{nullCheck(data.origin?.timezone?.abbr)} <br /> {nullCheck(data.origin?.timezone?.name)} </span>
      </div>
      ...
      <div>
        ...
        <span>
          {nullCheck(data.destination?.timezone?.abbr)} <br /> {nullCheck(data.destination?.timezone?.name)}
        </span>
      </div>
